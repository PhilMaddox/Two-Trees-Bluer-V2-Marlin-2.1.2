...
#define BLUER_TMC2209    // Enable for the TMC2209 driver version //PM
#define BLUER_INVERTED_E // Enable if the extruder runs the wrong way //PM
#define BLUER_BLTOUCH // Enable if you want to use BLTOUCH //PM
...
#define STRING_CONFIG_H_AUTHOR "(PM 29 Mar2023, BlueR BLT)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "PM Two Trees BlueR"
...
#define ENDSTOP_INTERRUPTS_FEATURE //PM
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 93 } //PM 
 ...
 */
//#define S_CURVE_ACCELERATION //PM
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 46, -9, -0.6 } // PM

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 15 //PM

// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_FEEDRATE (133*60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (6*60) //PM
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE    6 // Z Clearance for Deploy/Stow //PM
 ...
 */
//#define FILAMENT_RUNOUT_SENSOR //PM
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define ENABLE_LEVELING_FADE_HEIGHT
    ...
    #define DEFAULT_LEVELING_FADE_HEIGHT 5.0 // (mm) Default fade height.//PM
  #endif
