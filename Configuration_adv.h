...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MILLIMETER_UNITS       // Specify BABYSTEP_MULTIPLICATOR_(XY|Z) in mm instead of micro-steps //PM
  #define BABYSTEP_MULTIPLICATOR_Z  0.1       // (steps or mm) Steps or millimeter distance for each Z babystep //PM
 ...
 */
#define LIN_ADVANCE //PM
#if ENABLED(LIN_ADVANCE)
  #if ENABLED(DISTINCT_E_FACTORS)
    #define ADVANCE_K { 0.80 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.80        // (mm) Compression length applying to all extruders
  #endif
 ...
 */
// #define ADVANCED_PAUSE_FEATURE //PM
